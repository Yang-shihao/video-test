<template>
  <div class="video-wrap" :style="{ width: `${width}`, height: `${height}` }">
    ...
    <view class="abs-center">
      <!-- 中心播放按钮 -->
      <image
        src="../../static/x-video-player/play-btn.png"
        mode=""
        class="play-btn"
      ...
      <div class="video-loading" v-if="showLoading">
        <image
          src="../../static/x-video-player/loading.png"
          mode=""
          class="loading-btn"
        ></image>
      </div>
    ...
    <view :class="['controls-bar', controls ? 'show' : 'hide']">
      ...
      <view class="play-box" @click="videoPlayClick">
        <image
          src="../../static/x-video-player/pause.png"
          mode=""
          class="play-icon"
          v-if="isVideoPlay"
        ></image>
        <image
          src="../../static/x-video-player/play.png"
          mode=""
          class="play-icon"
          v-else
        ></image>
      ...
      <view class="mute-box" @click="videoMuteClick">
        <image
          src="../../static/x-video-player/sound.png"
          mode=""
          class="mute-icon"
          v-if="!isMute"
        ></image>
        <image
          src="../../static/x-video-player/mute.png"
          mode=""
          class="mute-icon"
          v-else
        ></image>
      ...
      <view class="play-full" @click="videoFull">
        <image
          src="../../static/x-video-player/fullscreen.png"
          mode=""
          class="play-icon"
          @click="videoFull"
        ></image>
